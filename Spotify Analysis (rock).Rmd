...
data <- rbind(data[c(1:300,701:800),], data[301:700,])
...
mean(random.model.accuracy) # accuracy = 57.03%
```
...
plot(x = data$year, y = data$mod.probs, col = factor(data$genre), main = "Predicted Probability of Rock Music by Release Year", xlab = "Year", ylab = "Predicted Probabilty of Rock")
legend("bottomleft", legend=unique(data$genre),
       col=factor(unique(data$genre)), pch=1, cex=0.8,
       title="Genres", text.font=4)

plot(x = data$p8, y = data$mod.probs, col = factor(data$genre), main = "Predicted Probability of Rock Music by 8th Pitch Class", xlab = "Pitch Class 8", ylab = "Predicted Probabilty of Rock")
